<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegCR.aspx.cs" Inherits="DB_M3.RegCR" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="center">
                <h2>Register as Club Representative</h2>
                <div class="data">
            ...
            <br />
            <asp:TextBox ID="club" CssClass="input" runat="server" placeholder="Club Name..."></asp:TextBox>
